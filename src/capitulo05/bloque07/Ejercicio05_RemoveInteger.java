...
public class Ejercicio05_RemoveInteger {
    public static void main(String[] args) {
        ...
        matriz = Arrays.copyOf(removeInteger(matriz, num), removeInteger(matriz, num).length);
        System.out.println("Array editada\n" + Arrays.toString(matriz));
    }

    public static int[] removeInteger(int[] matriz, int borrar){
        int[] aux = Arrays.copyOf(matriz,
                matriz.length - Ejercicio04_CountOcurrences.countOcurrences(matriz, borrar));
